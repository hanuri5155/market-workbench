...
- 240m/1440m MTF MA 소스 캔들 -> bot live candle update(best-effort/rate-limit) -> 내부 API(`/internal/mtf-ma-source-candle`) -> `/ws/zones` push -> UI
- 차트 진입/재연결/visibility 복귀 -> MTF MA 소스 캔들 REST resync -> UI 캐시 보정
